...
public class SudokuGenerator
{
   ...
   public SudokuGenerator() {
	 ...
	 */
	public void print(String path,int count)
	{
		try {
			FileWriter f = new FileWriter(path+"\\input"+count);
			for(int i=0;i<9;i++)
			{
				for(int j=0;j<9;j++)
				{
	...
	public static void main(String[] args)
	{
		for (int i = 0; i<50; ++i)
		{
			...
			sg.nextBoard(44);
			String path = "C:\\Users\\716705\\Documents\\GitHub\\SudokuCode\\sudoku_solution\\input\\37_clues_easy";
			sg.print(path, i);
		}
